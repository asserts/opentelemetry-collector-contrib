module github.com/asserts/opentelemetry-collector-contrib/receiver/receivercreator
...
require (
	...
	github.com/asserts/opentelemetry-collector-contrib/extension/observer v1.0.0.71.0-dev-0
