module github.com/asserts/opentelemetry-collector-contrib/receiver/kafkareceiver
...
require (
	...
	github.com/asserts/opentelemetry-collector-contrib/pkg/translator/jaeger v1.0.0.71.0-dev-0
