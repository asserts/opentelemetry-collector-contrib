module github.com/asserts/opentelemetry-collector-contrib/internal/filter
...
replace github.com/asserts/opentelemetry-collector-contrib/internal/coreinternal => ../coreinternal
