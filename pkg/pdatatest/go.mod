module github.com/asserts/opentelemetry-collector-contrib/pkg/pdatatest
...
replace github.com/asserts/opentelemetry-collector-contrib/pkg/pdatautil => ../pdatautil
