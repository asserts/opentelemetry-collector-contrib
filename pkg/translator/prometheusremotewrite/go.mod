module github.com/asserts/opentelemetry-collector-contrib/pkg/translator/prometheusremotewrite
...
replace github.com/asserts/opentelemetry-collector-contrib/pkg/translator/prometheus => ../prometheus
