module github.com/asserts/opentelemetry-collector-contrib/processor/attributesprocessor
...
require (
	...
	github.com/asserts/opentelemetry-collector-contrib/pkg/ottl v1.0.0.71.0-dev-0
