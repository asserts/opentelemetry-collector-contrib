module github.com/asserts/opentelemetry-collector-contrib/exporter/awsxrayexporter
...
require (
	...
	github.com/asserts/opentelemetry-collector-contrib/internal/aws/xray v1.0.0.71.0-dev-0
