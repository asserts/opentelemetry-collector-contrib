...
require (
	...
	github.com/asserts/opentelemetry-collector-contrib/internal/aws/ecsutil v1.71.0
	...
	github.com/asserts/opentelemetry-collector-contrib/internal/metadataproviders v1.71.0
